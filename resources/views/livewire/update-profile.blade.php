                                ...
                                <div wire:ignore.self class="tab-pane fade show rounded-bottom px-2 py-4"
                                    ...
                                    <form wire:submit.prevent="changePassword">
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-12 col-lg-8">
                                                <div class="input-group">
                                                    <input wire:model.debounce.500ms="kataSandiLama"
                                                    ...
                                                    <span wire:click="toggleShowPassword"
                                                        ...
                                                        <i class="fa-regular {{ $showPassword ? 'fa-eye' : 'fa-eye-slash' }}"
                                        ...
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-12 col-lg-8">
                                                <input wire:model.debounce.500ms="kataSandi"
                                                    type="{{ $showPassword ? 'text' : 'password' }}"
                                        ...
                                        <div class="row align-items-center mb-3">
                                            <div class="col-lg-4 mb-1 ms-1 mb-md-0 ms-md-0"><strong>Konfirmasi kata
                                                    sandi</strong></div>
                                            <div class="col-12 col-lg-8">
                                                <input wire:model.debounce.500ms="konfirmasiKataSandi"
                                                    type="{{ $showPassword ? 'text' : 'password' }}"

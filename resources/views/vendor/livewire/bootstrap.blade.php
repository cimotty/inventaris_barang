        ...
        <nav class="mt-2 mb-2 mx-4">
            <div class="row">
                ...
                <div class="col-sm-3 d-flex justify-content-center mx-auto">
                    <ul class="pagination" id="simplePagination">
                        {{-- Previous Page Link --}}
                        @if ($paginator->onFirstPage())
                            <li class="page-item disabled" aria-disabled="true">
                                <span class="page-link" style="color: seagreen">@lang('pagination.previous')</span>
                            </li>
                        @else
                            @if (method_exists($paginator, 'getCursorName'))
                                <li class="page-item">
                                    <button dusk="previousPage" type="button" class="page-link"
                                        ...
                                        style="color: seagreen">@lang('pagination.previous')</button>
                                </li>
                            @else
                                <li class="page-item">
                                    <button type="button"
                            ...
                            @if (method_exists($paginator, 'getCursorName'))
                                <li class="page-item">
                                    <button dusk="nextPage" type="button" class="page-link"
                                        ...
                                        style="color: seagreen">@lang('pagination.next')</button>
                                </li>
                            @else
                                <li class="page-item">
                                    <button type="button"
                        ...
                        @else
                            <li class="page-item disabled" aria-disabled="true">
                                <span class="page-link" style="color: seagreen">@lang('pagination.next')</span>
                            </li>
                        @endif
                    </ul>
                </div>
